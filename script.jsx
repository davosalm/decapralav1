...
// Função para normalizar strings para comparação (esta função estava faltando)
const normalizeStringForComparison = (str) => {
  ...
  try {
    ...
    const alphanumeric = lowercase.replace(/[^\w\s]/g, '');
    
    // Remover underscores e espaços extras
    return alphanumeric.replace(/_/g, ' ').trim();
  } catch (e) {
...
function App() {
  ...
  const validateAllPairs = async () => {
    ...
    // Validar apenas os pares de backup como exemplo
    const backupPairs = [
      {
        start: "Santos_Dumont",
        startDisplay: "Santos Dumont",
...
const root = createRoot(document.getElementById("root"));
root.render(<App />);
>>>>>>> d0d6a68cdf990b7c3c89d75e221459e5c3772d17
